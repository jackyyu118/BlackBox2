...
import top.niunaijun.blackbox.reflect.android.app.job.BRJobInfo;
...
public class BJobManagerService extends IBJobManagerService.Stub implements ISystemService {
    ...
    public JobInfo scheduleJob(ProcessRecord processRecord, JobInfo info, ServiceInfo serviceInfo) {
        ...
        BRJobInfo.service.set(info,new ComponentName(BlackBoxCore.getHostPkg(), ProxyManifest.getProxyJobService(processRecord.bpid)));
        return info;
    }
